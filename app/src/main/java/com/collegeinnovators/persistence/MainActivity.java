package com.collegeinnovators.persistence;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        Open Sahred preference in PRIVATE mode (initializing preference) so that other
        applications cannot access the stored in the memory by our application
         */
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                ...
                It works just like save feature in NotePad or MS Word
                */
                editor.commit();
